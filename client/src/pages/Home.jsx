...
import { saveLatestScan } from '../lib/latestScan';
...
function Home() {
  ...
  const handleScan = async () => {
    ...
    try {
      // The scan is filed under the id in the access token — the client no longer sends a userId.
      const data = await api.analyze(selectedFile);
